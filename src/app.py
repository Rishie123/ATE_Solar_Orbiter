...
figures = [create_figure(prepare_data(df, type_label), f'Normalized Average Treatment Effects of Heater Profiles for : {get_custom_title(type_label)}') for type_label in types]
